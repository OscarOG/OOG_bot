...
//	Entities for Svencoop 4.8
//	By OOG
//	17/05/2017

LINK_ENTITY_TO_FUNC(ammo_556clip);
LINK_ENTITY_TO_FUNC(ammo_sporeclip);
LINK_ENTITY_TO_FUNC(desert_eagle_spot);
LINK_ENTITY_TO_FUNC(func_clip);
LINK_ENTITY_TO_FUNC(game_player_counter);
LINK_ENTITY_TO_FUNC(game_slot_counter);
LINK_ENTITY_TO_FUNC(global_light_control);
LINK_ENTITY_TO_FUNC(info_monster_goal);
LINK_ENTITY_TO_FUNC(info_node_elevator);
LINK_ENTITY_TO_FUNC(info_node_ladder);
LINK_ENTITY_TO_FUNC(info_vehicle_attachement);
LINK_ENTITY_TO_FUNC(info_vehicle_control);
LINK_ENTITY_TO_FUNC(info_vehicle_seat);
LINK_ENTITY_TO_FUNC(info_vehicle_tire);
LINK_ENTITY_TO_FUNC(info_vehicle_weapon);
LINK_ENTITY_TO_FUNC(item_armorvest);
LINK_ENTITY_TO_FUNC(item_helmet);
LINK_ENTITY_TO_FUNC(kingpin_crawler_beam);
LINK_ENTITY_TO_FUNC(kingpin_plasma_ball);
LINK_ENTITY_TO_FUNC(kingpin_teleport_check);
LINK_ENTITY_TO_FUNC(monster_alien_commander);
LINK_ENTITY_TO_FUNC(monster_alien_tor);
LINK_ENTITY_TO_FUNC(monster_bodyguard);
LINK_ENTITY_TO_FUNC(monster_handgrenade);
LINK_ENTITY_TO_FUNC(monster_kingpin);
LINK_ENTITY_TO_FUNC(monster_sqknest);
LINK_ENTITY_TO_FUNC(monster_stukabat);
LINK_ENTITY_TO_FUNC(rpg_laser_spot);
LINK_ENTITY_TO_FUNC(trigger_cameratarget);
LINK_ENTITY_TO_FUNC(trigger_change_class);
LINK_ENTITY_TO_FUNC(trigger_changemodel);
LINK_ENTITY_TO_FUNC(trigger_condition);
LINK_ENTITY_TO_FUNC(trigger_copyvalue);
LINK_ENTITY_TO_FUNC(trigger_create_entity);
LINK_ENTITY_TO_FUNC(trigger_createentity);
LINK_ENTITY_TO_FUNC(trigger_entity_iterator);
LINK_ENTITY_TO_FUNC(trigger_hurt_remote);
LINK_ENTITY_TO_FUNC(trigger_load);
LINK_ENTITY_TO_FUNC(trigger_lookat);
LINK_ENTITY_TO_FUNC(trigger_renameplayer);
LINK_ENTITY_TO_FUNC(trigger_save);
LINK_ENTITY_TO_FUNC(trigger_setcvar);
LINK_ENTITY_TO_FUNC(trigger_track_goal);
LINK_ENTITY_TO_FUNC(trigger_vote);
LINK_ENTITY_TO_FUNC(vehicle_thinker);
LINK_ENTITY_TO_FUNC(weapon_saw);


//	Entities for Svencoop 5.12
//	By OOG
//	17/05/2017

LINK_ENTITY_TO_FUNC(custom);
LINK_ENTITY_TO_FUNC(displacer_portal);
LINK_ENTITY_TO_FUNC(env_render_individual);
LINK_ENTITY_TO_FUNC(func_mirror);
LINK_ENTITY_TO_FUNC(func_monitor);
LINK_ENTITY_TO_FUNC(func_portal);
LINK_ENTITY_TO_FUNC(hyper_cube);
LINK_ENTITY_TO_FUNC(item_inventory);
LINK_ENTITY_TO_FUNC(path_waypoint);
LINK_ENTITY_TO_FUNC(trigger_changemaxammo);
LINK_ENTITY_TO_FUNC(trigger_cyclicobserver);
LINK_ENTITY_TO_FUNC(trigger_numericdisplay);
LINK_ENTITY_TO_FUNC(weapon_9mmar);


//	Entities for BrainBread 1.2
//	By OOG
//	17/05/2017

LINK_ENTITY_TO_FUNC(bb_ammo);
LINK_ENTITY_TO_FUNC(bb_custommission);
LINK_ENTITY_TO_FUNC(bb_equipment);
LINK_ENTITY_TO_FUNC(bb_escape_final);
LINK_ENTITY_TO_FUNC(bb_escape_radar);
LINK_ENTITY_TO_FUNC(bb_escapeair);
LINK_ENTITY_TO_FUNC(bb_funk);
LINK_ENTITY_TO_FUNC(bb_healthkit);
LINK_ENTITY_TO_FUNC(bb_mapmission);
LINK_ENTITY_TO_FUNC(bb_mission_zone);
LINK_ENTITY_TO_FUNC(bb_objective_item);
LINK_ENTITY_TO_FUNC(bb_objectives);
LINK_ENTITY_TO_FUNC(bb_spawn_player);
LINK_ENTITY_TO_FUNC(bb_spawn_zombie);
LINK_ENTITY_TO_FUNC(bb_tank);
LINK_ENTITY_TO_FUNC(bb_waypoint);
LINK_ENTITY_TO_FUNC(bb_zombie_player);
LINK_ENTITY_TO_FUNC(mapobject_jaguar);
LINK_ENTITY_TO_FUNC(mapobject_npc_bum);
LINK_ENTITY_TO_FUNC(mapobject_npc_bum1);
LINK_ENTITY_TO_FUNC(mapobject_npc_bum2);
LINK_ENTITY_TO_FUNC(mapobject_npc_bum3);
LINK_ENTITY_TO_FUNC(mapobject_npc_crow);
LINK_ENTITY_TO_FUNC(mapobject_npc_slavebot);
...
//	Entities for Contra-Force 1.4b
//	By OOG
//	18/05/2017

LINK_ENTITY_TO_FUNC(ammo_127x99rifle);
LINK_ENTITY_TO_FUNC(ammo_12guagebuck);
LINK_ENTITY_TO_FUNC(ammo_12guageslug);
LINK_ENTITY_TO_FUNC(ammo_300winmag);
LINK_ENTITY_TO_FUNC(ammo_40mmgrenades);
LINK_ENTITY_TO_FUNC(ammo_44revolver);
LINK_ENTITY_TO_FUNC(ammo_45acppistol);
LINK_ENTITY_TO_FUNC(ammo_45acpsmg);
LINK_ENTITY_TO_FUNC(ammo_556x45asrifle);
LINK_ENTITY_TO_FUNC(ammo_556x45mg);
LINK_ENTITY_TO_FUNC(ammo_762x39asrifle);
LINK_ENTITY_TO_FUNC(ammo_762x51rifle);
LINK_ENTITY_TO_FUNC(ammo_9x19pistol);
LINK_ENTITY_TO_FUNC(ammo_9x19smg);
LINK_ENTITY_TO_FUNC(ammo_allbox);
LINK_ENTITY_TO_FUNC(ammo_fullbox);
LINK_ENTITY_TO_FUNC(ammo_grenades);
LINK_ENTITY_TO_FUNC(func_rotatingforvehicle);
LINK_ENTITY_TO_FUNC(info_player_barter);
LINK_ENTITY_TO_FUNC(item_battery2);
LINK_ENTITY_TO_FUNC(item_battery3);
LINK_ENTITY_TO_FUNC(item_nvg);
LINK_ENTITY_TO_FUNC(item_parachute);
LINK_ENTITY_TO_FUNC(monster_bad_barney);
LINK_ENTITY_TO_FUNC(monster_barry);
LINK_ENTITY_TO_FUNC(monster_barry_dead);
LINK_ENTITY_TO_FUNC(monster_blowfly);
LINK_ENTITY_TO_FUNC(monster_blowflyqueen);
LINK_ENTITY_TO_FUNC(monster_commando);
LINK_ENTITY_TO_FUNC(monster_hcomu_dead);
LINK_ENTITY_TO_FUNC(monster_human_assassin2);
LINK_ENTITY_TO_FUNC(monster_human_communism);
LINK_ENTITY_TO_FUNC(monster_human_terrorist);
LINK_ENTITY_TO_FUNC(monster_mesa_grunt);
LINK_ENTITY_TO_FUNC(monster_panthereye);
LINK_ENTITY_TO_FUNC(monster_terrorist_repel);
LINK_ENTITY_TO_FUNC(parachute_follow);
LINK_ENTITY_TO_FUNC(Rocket);
LINK_ENTITY_TO_FUNC(weapon_ar50);
LINK_ENTITY_TO_FUNC(weapon_ber92fs);
LINK_ENTITY_TO_FUNC(weapon_car15m203);
LINK_ENTITY_TO_FUNC(weapon_g3a3);
LINK_ENTITY_TO_FUNC(weapon_hk33zf);
LINK_ENTITY_TO_FUNC(weapon_m16a2);
LINK_ENTITY_TO_FUNC(weapon_m16m203);
LINK_ENTITY_TO_FUNC(weapon_m1911);
LINK_ENTITY_TO_FUNC(weapon_m1911a1);
LINK_ENTITY_TO_FUNC(weapon_m629);
LINK_ENTITY_TO_FUNC(weapon_m67grenade);
LINK_ENTITY_TO_FUNC(weapon_m700);
LINK_ENTITY_TO_FUNC(weapon_m72a1);
LINK_ENTITY_TO_FUNC(weapon_m870);
LINK_ENTITY_TO_FUNC(weapon_minimi);
LINK_ENTITY_TO_FUNC(weapon_mk2grenade);
LINK_ENTITY_TO_FUNC(weapon_mp5a2);
LINK_ENTITY_TO_FUNC(weapon_mp5a3);
LINK_ENTITY_TO_FUNC(weapon_mp5ka4);
LINK_ENTITY_TO_FUNC(weapon_n213);
LINK_ENTITY_TO_FUNC(weapon_psg1);
LINK_ENTITY_TO_FUNC(weapon_sks45);
LINK_ENTITY_TO_FUNC(weapon_spas12);
LINK_ENTITY_TO_FUNC(weapon_type56);

//	Entities for Decay
//	By OOG
//	21/03/2018

LINK_ENTITY_TO_FUNC(displacer_teleporter);
LINK_ENTITY_TO_FUNC(effect_warpball);
LINK_ENTITY_TO_FUNC(env_dlight);
LINK_ENTITY_TO_FUNC(env_elight);
LINK_ENTITY_TO_FUNC(env_lasermirror);
LINK_ENTITY_TO_FUNC(env_lensflare);
LINK_ENTITY_TO_FUNC(env_mirroredlaser);
LINK_ENTITY_TO_FUNC(env_rtcamera);
LINK_ENTITY_TO_FUNC(env_shockwave);
LINK_ENTITY_TO_FUNC(env_warpball);
LINK_ENTITY_TO_FUNC(func_frame);
LINK_ENTITY_TO_FUNC(func_lasermirror);
LINK_ENTITY_TO_FUNC(func_notepad);
LINK_ENTITY_TO_FUNC(info_cheathelper);
LINK_ENTITY_TO_FUNC(info_displacer_xen_target);
LINK_ENTITY_TO_FUNC(info_emittertarget);
LINK_ENTITY_TO_FUNC(info_flaghelper);
LINK_ENTITY_TO_FUNC(item_eyescanner);
LINK_ENTITY_TO_FUNC(item_focusemitter);
LINK_ENTITY_TO_FUNC(item_healthcharger);
LINK_ENTITY_TO_FUNC(item_healthchargertank);
LINK_ENTITY_TO_FUNC(item_recharge);
LINK_ENTITY_TO_FUNC(item_rechargeglass);
LINK_ENTITY_TO_FUNC(item_slave_collar);
LINK_ENTITY_TO_FUNC(monster_alien_priest);
LINK_ENTITY_TO_FUNC(monster_alienflyer);
LINK_ENTITY_TO_FUNC(monster_modeltrain);
LINK_ENTITY_TO_FUNC(monster_rosenberg);
LINK_ENTITY_TO_FUNC(monster_wheelchair);
LINK_ENTITY_TO_FUNC(priest_energy_ball);
LINK_ENTITY_TO_FUNC(priest_head_ball);
LINK_ENTITY_TO_FUNC(trigger_autobot);
LINK_ENTITY_TO_FUNC(trigger_bit);
LINK_ENTITY_TO_FUNC(trigger_bit_counter);
LINK_ENTITY_TO_FUNC(trigger_clientspawn);
LINK_ENTITY_TO_FUNC(trigger_enddecay);
LINK_ENTITY_TO_FUNC(trigger_kicker);
LINK_ENTITY_TO_FUNC(trigger_lockedmission);
LINK_ENTITY_TO_FUNC(trigger_new_hurt);
LINK_ENTITY_TO_FUNC(trigger_playerfreeze);
LINK_ENTITY_TO_FUNC(trip_beam);
LINK_ENTITY_TO_FUNC(weapon_displacer);
LINK_ENTITY_TO_FUNC(weapon_vorti);
