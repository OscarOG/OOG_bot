...
// game messages for Contra-Force buy menu
#define MSG_CF_IDLE					0
#define MSG_CF_BARTER_AREA			1
#define MSG_CF_BARTER				2
#define MSG_CF_BARTER_WEAPON		3
#define MSG_CF_BARTER_MAINARM		4
#define MSG_CF_BARTER_SUBARM		5
#define MSG_CF_BARTER_SIDEARM		6
#define MSG_CF_BARTER_EXPLOSIVE		7
#define MSG_CF_BARTER_EQUIP			8
#define MSG_CF_BARTER_AMMO			9
...
// TheFatal - END
   ...
   int bot_money;        // for Counter-Strike & Contra-Force
