...
/*	  else if (mod_id == CONFORCE_DLL)
         pBot->start_action = MSG_CF_BARTER_AREA;	*/
      else
	  ...
	  pBot->in_barter_area = 0;	//	Not interested in buy zone yet
...
//jlb      if (RANDOM_LONG(1, 100) <= 80)  // only vote 80% of the time
      {
//jlb         if (RANDOM_LONG(1, 100) <= 50)
            FakeClientCommand(pEdict, "vote_yes", NULL, NULL);
//jlb         else
//jlb            FakeClientCommand(pEdict, "vote_no", NULL, NULL);
      }
   ...
   {
//jlb      if (holywars_gamemode == 0)  // currently deathmatch?
//jlb          FakeClientCommand(pEdict, "callvote_instagib", NULL, NULL);
//jlb      else
//jlb          FakeClientCommand(pEdict, "callvote_deathmatch", NULL, NULL);
